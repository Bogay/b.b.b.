...
{
    public DeadLine line; // 死亡判定線
    private CanvasGroup group; // UI 畫布的元件管理者
    private bool invoked = false; // 是否已觸發的 bool
    ...
    void Start()
    {
        ...
        this.line.OnBrickEnter.AddListener(this.ShowCanvas); // 向死亡判定線的OnBrickEnter事件註冊ShowCanvas函式
    }
